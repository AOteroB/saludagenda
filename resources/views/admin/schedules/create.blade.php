...
<div class="container py-4">
    ...
    <div class="glass-card p-4 border border-primary">
        <div class="row">
            {{-- Formulario --}}
            <div class="col-md-4">
                <h5 class="text-black mb-4"><i class="fas fa-calendar-plus me-2"></i>Datos del Horario</h5>
                                    ...
                                    @for ($day = 1; $day <= 6; $day++)
                                        <td>
                                            @foreach ($schedules as $schedule)
                                                @php
                                                    $doctorColor = 'doctor-color-' . ($schedule->doctor->id % 8); // color hash
                                                @endphp
...
<style>
    ...
    .doctor-color-0 { background-color: #1e88e5; color: #fff; }  /* Azul */
    .doctor-color-1 { background-color: #43a047; color: #fff; }  /* Verde */
    .doctor-color-2 { background-color: #f4511e; color: #fff; }  /* Naranja */
    .doctor-color-3 { background-color: #6d4c41; color: #fff; }  /* Marrón */
    .doctor-color-4 { background-color: #8e24aa; color: #fff; }  /* Morado */
    .doctor-color-5 { background-color: #00897b; color: #fff; }  /* Turquesa */
    .doctor-color-6 { background-color: #c2185b; color: #fff; }  /* Rosa fuerte */
    .doctor-color-7 { background-color: #fbc02d; color: #000; }  /* Amarillo */
    .doctor-color-8 { background-color: #5e35b1; color: #fff; }  /* Indigo */
    .doctor-color-9 { background-color: #00acc1; color: #fff; }  /* Cyan */
    .doctor-color-10 { background-color: #e53935; color: #fff; } /* Rojo intenso */
    .doctor-color-11 { background-color: #7cb342; color: #fff; } /* Lima */
    .doctor-color-12 { background-color: #fb8c00; color: #fff; } /* Naranja fuerte */
    .doctor-color-13 { background-color: #3949ab; color: #fff; } /* Azul oscuro */
    .doctor-color-14 { background-color: #00c853; color: #fff; } /* Verde brillante */
